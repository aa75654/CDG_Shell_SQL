update revenue_order_detail@CDG001T_QICT.CORP.LITEL.COM set invoice_no=null where revord_id in (select revord_id from revenue_order@CDG001T_QICT.CORP.LITEL.COM where bill_yr_mo=202008);
commit;
