delete from LDAP_INACTIVE_USERS@CDG001T_QICT.CORP.LITEL.COM;
...
Insert into CDG_PROCESS_LOG@CDG001T_QICT.CORP.LITEL.COM
 ...
 Values
   ((select max(process_seq+1) from cdg_process_log@CDG001T_QICT.CORP.LITEL.COM), 8000, 2019723, sysdate, null, 
